...
export default function Contact() {
  // Build a mailto: link from the form fields and open the visitor's email app.
                ...
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="font-semibold text-maroon underline decoration-sand underline-offset-2 hover:text-maroon-deep hover:decoration-maroon"
                    >
                      {business.area}
                    </a>
                  </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-[16px] border border-sand bg-mist/40 p-6">
                ...
                <p className="mt-2 text-sm text-ink/75">
                  We accept Zelle, checks, and cash. Send Zelle payments to the number below.
                </p>
